 ...
 * @author carlo
 */
public class ItemFacturadoFacturaCliente {
    ...
    public ItemFacturadoFacturaCliente(int codigoItemFacturado, int codigoFactura, String descripcionItemFacturado, Double cantidadItemFacturado, Double importeItemFacturado, Double totalItemFacturado) {
    ...
    public ItemFacturadoFacturaCliente() {
    }
    ...
    public boolean facturarItem(ItemFacturadoFacturaCliente itemFacturado){
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement("INSERT INTO items_facturados_factura_cliente (codigo_item_facturado, codigo_factura, descripcion_item_facturado, cantidad_item_facturado, importe_item_facturado, total_item_facturado) "
                    + "VALUES (?,?,?,?,?,?)");
